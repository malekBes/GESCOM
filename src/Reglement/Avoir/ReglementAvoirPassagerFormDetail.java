 ...
 * @author Mlek
 */
public class ReglementAvoirPassagerFormDetail extends javax.swing.JInternalFrame {
     ...
     */
    public ReglementAvoirPassagerFormDetail(String type_client, String type_reglement) {
         initComponents();
        setIconifiable(true);
        setMaximizable(true);
        setResizable(true);
...
//Remove rows one by one from the end of the table
    ...
    public void lstFacture() {
        ...
        Vector<Vector<Object>> data1 = FactureDao.afficherListAvoirPassager(nomclient);
    ...
    private void initComponents() {
        ...
        setResizable(true);
        setTitle("Reglement Avoir Passager");
            ...
            if (d != null) {
                ...
                if ((date_reglement.compareTo(date_facture) > 0) || (date_reglement.compareTo(date_facture) == 0)) {
                    ...
                    if (x <= Double.valueOf(txt_m_total_facture.getText())) {
                        ...
                        if (fdao.ajouterReglementAvoirPassager(d)) {
