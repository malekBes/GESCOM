 ...
 * @author Mlek
 */
public class ReglementFournisseurFormDetail extends javax.swing.JInternalFrame {
     ...
     */
    public ReglementFournisseurFormDetail(String type_client, String type_reglement) {
         initComponents();
        setIconifiable(true);
        setMaximizable(true);
        setResizable(true);
    ...
    private void update_table() {
        ...
        df_reglement = reglementDAO.afficherTableReglement(Table_reglement, numFacture);
...
//Remove rows one by one from the end of the table
    ...
    DefaultTableModel df_reglement;
    ...
    public void lstFacture() {
        ...
        if (id_four.isEmpty()) {
            JOptionPane.showMessageDialog(this, "Veuillez choisir un fournisseur ! ");
        } else {
            ...
            Vector<Vector<Object>> data1 = FactureDao.afficherListFactureForunisseur(id_four);
    ...
    private void initComponents() {
        ...
        jLabel6.setText("Total avoir encours");
        ...
        ComboBox_type_reglement.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                ComboBox_type_reglementActionPerformed(evt);
            }
        });
    ...
    private void btn_validerActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_validerActionPerformed
        try {
            ...
            if (d != null) {
                Date date_reglement = null;
                try {

                    String str = d.getDate_reglement();
                    DateFormat format = new SimpleDateFormat("yyyy-MM-dd");
                    date_reglement = format.parse(str);
                } catch (Exception e) {
                }

                Date date_facture = null;
                try {

                    String dt = daofacture.getDateFactureFournisseur(txt_facture.getText());
                    date_facture = new SimpleDateFormat("yyyy-MM-dd").parse(dt);
...
//date_reglement is after date_facture
                if ((date_reglement.compareTo(date_facture) > 0) || (date_reglement.compareTo(date_facture) == 0)) {
                    ...
                    if (x <= Double.valueOf(txt_m_total_facture.getText())) {
                        ...
                        if (fdao.ajouterReglementFournisseur(d)) {

                            JOptionPane.showMessageDialog(null, "Reglemnet Fournisseru à été bien enregistré !");
                            update_table();
                            if (Double.parseDouble(txt_m_restant.getText()) == 0.0) {
                                daofacture.setFactureReglementFournisseur(txt_facture.getText(), "Oui");
                                clearForm("all");
                            } else {
                                daofacture.setFactureReglementFournisseur(txt_facture.getText(), "Semi");
                                clearForm("semi");
                            }
    ...
    private void ComboBox_fourActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ComboBox_fourActionPerformed
        ...
        if (b) {
            if (ComboBox_four.getSelectedItem() != "-") {
                ...
                df_avoir = r.afficherTableAvoirFournisseur(Table_avoir, ss);
                Double tot = 0.0;
    ...
    private void ComboBox_type_reglementActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ComboBox_type_reglementActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_ComboBox_type_reglementActionPerformed
