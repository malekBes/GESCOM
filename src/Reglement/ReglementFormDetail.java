 ...
 * @author Mlek
 */
public class ReglementFormDetail extends javax.swing.JInternalFrame {
     ...
     */
    public ReglementFormDetail(String type_client, String type_reglement) {
         initComponents();
        setIconifiable(true);
        setMaximizable(true);
        setResizable(true);
...
//Remove rows one by one from the end of the table
    ...
    public void lstFacture() {
        ...
        Vector<Vector<Object>> data1 = FactureDao.afficherListFacture(id_client);
    ...
    private void initComponents() {
        ...
        setResizable(true);
        setTitle("Reglement Facture Client");
...
//jTable.setRowSorter(rowSorter);
        ...
        jbtValider.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                ...
                df_avoir = r.afficherTableAvoirClient(Table_avoir, id_client);
                Double tot = 0.0;
