 ...
 * @author Mlek
 */
public class ReglementPassagerFormDetail extends javax.swing.JInternalFrame {
     ...
     */
    public ReglementPassagerFormDetail(String type_client, String type_reglement) {
         initComponents();
        setIconifiable(true);
        setMaximizable(true);
        setResizable(true);
...
//Remove rows one by one from the end of the table
    ...
    public void lstFacture() {
        ...
        Vector<Vector<Object>> data1 = FactureDao.afficherListFacturePassager(nomclient);
        ...
        jbtValider.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                ...
                TTC = Config.Commen_Proc.formatDouble(Double.parseDouble(jTable.getModel().getValueAt(jTable.getSelectedRow(), 2).toString()));
                txt_m_total_facture.setText(TTC);
                txt_m_regle_total.setText("0");
                txt_m_restant.setText("0");

                String NomPassager = jTable.getModel().getValueAt(jTable.getSelectedRow(), 0).toString();
                txt_search.setText(NomPassager);
    ...
    private void initComponents() {
        ...
        setResizable(true);
        setTitle("Reglement Facture Passager");

        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder("Info Passager"));
    ...
    private void jButton7ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton7ActionPerformed
        ...
        ClientDao clientDao = new ClientDao();
        Vector<Vector<Object>> data1 = clientDao.afficherListClientPassager();
        DefaultTableModel model = new DefaultTableModel(data1, columnNames);
        JTable jTable = new JTable(model);
        ...
        jbtValider.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                ...
                df_avoir = r.afficherTableAvoirPassager(Table_avoir, nomclient);
                Double tot = 0.0;
    ...
    private void btn_validerActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_validerActionPerformed
        try {
            ...
            if (d != null) {
                ...
                String dt = daofacture.getDateFacture(txt_facture.getText());
                ...
                if ((date_reglement.compareTo(date_facture) > 0) || (date_reglement.compareTo(date_facture) == 0)) {
                    ...
                    if (x <= Double.valueOf(txt_m_total_facture.getText())) {
                        ...
                        if (fdao.ajouterReglementPassager(d)) {

                            JOptionPane.showMessageDialog(null, "Reglemnet à été bien enregistré !");
                            update_table();
                            if (Double.parseDouble(txt_m_restant.getText()) == 0.0) {
                                daofacture.setFactureReglement(txt_facture.getText(), "Oui");
                                clearForm("all");
                            } else {
                                daofacture.setFactureReglement(txt_facture.getText(), "Semi");
                                clearForm("semi");
                            }
    ...
    public Reglement setReglementFromEditText() {
        ...
        if (!txt_search.getText().isEmpty()) {
            r.setPassager(txt_search.getText());
        } else {
            r.setNum_avoir("");
            return null;
        }
