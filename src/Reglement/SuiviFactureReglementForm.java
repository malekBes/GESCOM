 ...
 * @author Mlek
 */
public class SuiviFactureReglementForm extends javax.swing.JInternalFrame {
     ...
     */
    public SuiviFactureReglementForm() {
    ...
    public void SearchDevis() {
        try {
            ...
            //  afficherFactureSuiviGroupedByClient
            rechercheDao.SuiviReglement(FactureHist_Table, FromDate,
                    ToDate, "", "", txt_num_devis.getText(),
                    id_clients, type_filtre, commercial_id);
            setHeaders();
        } catch (Exception e) {
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        try {
            ...
            h.put("table_title", "Facture Impayée");
            ...
            JasperExportManager.exportReportToPdfFile(jp, Commen_Proc.PathPDF + "Facture Impayée.pdf");
            
                   File myObj = new File(Commen_Proc.PathExcel + "Facture Impayée" + ".xls");
            String error = Config.ExpotToExcel.exportExcelStat(FactureHist_Table, myObj, "Facture Impayee");
