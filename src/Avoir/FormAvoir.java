 ...
 * @author Mlek
 */
public class FormAvoir extends javax.swing.JInternalFrame {
     ...
     */
    public FormAvoir(String Num_Devis) {
...
// TODO add your handling code here:
    ...
    private void jButton11ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton11ActionPerformed
        ...
        Vector<Vector<Object>> data1 = clientDao.afficherListFactureAvoir(id_client);
        DefaultTableModel model = new DefaultTableModel(data1, columnNames);
        JTable jTable = new JTable(model);
    ...
    public void ListFacture(String num_facture) {
        try {
            ...
            df = avoirDao.afficherListItemsFacture(Devis_Table, num_facture);
            ...
            try {
                ...
                Logger.getLogger(FormAvoir.class.getName()).log(Level.SEVERE, null, ex);
            }
        }
    }
