 ...
 * @author Mlek
 */
public class FormAvoirPassager extends javax.swing.JInternalFrame {
     ...
     */
    public FormAvoirPassager(String Num_Devis) {
    ...
    private void initComponents() {
        ...
        txt_passager.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                txt_passagerActionPerformed(evt);
            }
        });
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                ...
                                .addGap(18, 18, 18)
                                .addComponent(txt_passager, javax.swing.GroupLayout.PREFERRED_SIZE, 153, javax.swing.GroupLayout.PREFERRED_SIZE))
                            .addGroup(jPanel1Layout.createSequentialGroup()
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        try {
            ...
            if (c.DateCheckOnUpdate("avoir", "date_avoir", "num_avoir", d.getNum_Devis(), d.getDate_devis())) {
                if (avoirDao.ajouterAvoir(d)) {
                    avoirDao.ajouterLigneAvoir(lstd);
                    JOptionPane.showMessageDialog(null, "Avoir num " + txt_num_devis.getText() + " à été bien enregistré !");
                    DevisDao devisDao = new DevisDao();
                    devisDao.modifierStockAvoirOnDelete(lstd);
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        Double HT = Double.valueOf(prix_u) * Integer.valueOf(qte);
        Devis_Table.getModel().setValueAt(formatDouble(HT), row, 5);

        Devis_Table.getModel().setValueAt(ref, row, 1);
        Devis_Table.getModel().setValueAt(design, row, 2);
        Devis_Table.getModel().setValueAt(formatString(prix_u), row, 3);
...
//jTable.setRowSorter(rowSorter);
    ...
    private void jButton11ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton11ActionPerformed
        ...
        columnNames.add("Nom Passager");
        columnNames.add("Code TVA");
        columnNames.add("Adresse");

        FactureDAO factureDAO = new FactureDAO();
        Vector<Vector<Object>> data1 = factureDAO.afficherListFactureAvoirPassager(id_client);
        DefaultTableModel model = new DefaultTableModel(data1, columnNames);
        JTable jTable = new JTable(model);
        ...
        jbtValider.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                ...
                String Nom = jTable.getModel().getValueAt(jTable.getSelectedRow(), 1).toString();
                String Code = jTable.getModel().getValueAt(jTable.getSelectedRow(), 2).toString();
                String adresse = jTable.getModel().getValueAt(jTable.getSelectedRow(), 3).toString();

                /*  ArticleDao d = new ArticleDao();

                String nom_code_adresse = d.getNameItemByIdNomCodeAdresseClient(Num_facture);
                String[] s = nom_code_adresse.split(";");
                txt_passager.setText(s[0]);
                txt_Code_TVA.setText(s[1]);
                txt_infos_devis.setText(s[2]);*/
                txt_infos_devis.setText(adresse);

                txt_num_facture.setText(Num_facture);
                txt_Code_TVA.setText(Code);
                txt_passager.setText(Nom);
    ...
    private void txt_passagerActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_txt_passagerActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_txt_passagerActionPerformed
    ...
    public void ListFacture(String num_facture) {
        try {
            ...
            df = avoirDao.afficherListItemsFacturePassager(Devis_Table, num_facture);
            ...
            try {
                ...
                Logger.getLogger(FormAvoirPassager.class.getName()).log(Level.SEVERE, null, ex);
            }
        }
    }
    ...
    private void setNumAvoir() {
        ...
        String s = avoirDao.maxNumAvoir(year + "A");
        String formatted;
        if (!s.isEmpty()) {
            String t[] = s.split("A");
            int x = Integer.valueOf(t[1]) + 1;
            formatted = String.format("%05d", x);
            String num_devis = year + "A" + formatted;
