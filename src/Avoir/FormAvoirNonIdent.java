 ...
 * @author Mlek
 */
public class FormAvoirNonIdent extends javax.swing.JInternalFrame {
     ...
     */
    public FormAvoirNonIdent(String Num_Devis) {
...
//jTable.setRowSorter(rowSorter);
    ...
    public void avoirComboBox() {
        ...
        daof.listNumAvoir(ComboBox_HistAvoir, "Non_Ident", id_client);
    }
...
// TODO add your handling code here:
    ...
    public void ListFacture(String num_facture) {
        try {
            ...
            avoirDao.afficherListItemsFacture(Devis_Table, num_facture);
            ...
            try {
                ...
                Logger.getLogger(FormAvoirNonIdent.class.getName()).log(Level.SEVERE, null, ex);
            }
        }
    }
