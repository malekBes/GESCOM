...
public class RecherchResaForm extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        setClosable(true);
        setTitle("Consultation Réservation");
        ...
        jPanel3.setBorder(javax.swing.BorderFactory.createTitledBorder("Detail Réservation"));
        ...
        jButton2.setText("Annuler Réservation");
        ...
        jPanel5.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Réservation", javax.swing.border.TitledBorder.CENTER, javax.swing.border.TitledBorder.DEFAULT_POSITION));
    ...
    void setHeaders() {
        ...
        DevisHist_Table.getColumnModel().getColumn(1).setHeaderValue("Num Réservation");

        DevisHist_Table.getColumnModel().getColumn(2).setHeaderValue("Date Réservation");
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        if (row != -1) {
            ...
            if (JOptionPane.showConfirmDialog(null, "Voulez-vous annuler la Réservation Num " + s + " ?  ", "Confirmation !!!",
                    JOptionPane.YES_NO_OPTION) == JOptionPane.YES_OPTION) {
                reservationDao.updateStatutResa(s);
                JOptionPane.showMessageDialog(this, "La Réservation Num : " + s + " à été annulée ! ");
