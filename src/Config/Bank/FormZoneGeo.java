 ...
 * @author Mlek
 */
public class FormZoneGeo extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        setClosable(true);
        setResizable(true);
        setTitle("Création Zone Géographique");

        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder("Zone Géographique"));

        jLabel1.setText("Zone Géographique");
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        bankDao.supprimerZoneGeo(value);
        update_table();
    ...
    private void update_table() {
        BankDao bankDao = new BankDao();
        bankDao.afficherZoneGeo(Bank_Table);
