 ...
 * @author Mlek
 */
public class Formtype_clientProduit extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        setClosable(true);
        setResizable(true);
        setTitle("Création Type Client");

        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder("Type Client"));

        jLabel1.setText("Type Client");
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        bankDao.supprimerTypeClient(value);
        update_table();
    ...
    private void update_table() {
        BankDao bankDao = new BankDao();
        bankDao.afficherTypeClient(Bank_Table);
