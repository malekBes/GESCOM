 ...
 * @author Mlek
 */
public class FormEtatPayement extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        setClosable(true);
        setResizable(true);
        setTitle("Création Etat Paiement ");

        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder("Etat Paiement "));

        jLabel1.setText("Etat Paiement ");
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        bankDao.supprimerEtatPayement(value);
        update_table();
    ...
    private void update_table() {
        BankDao bankDao = new BankDao();
        bankDao.afficherEtatPayement(Bank_Table);
