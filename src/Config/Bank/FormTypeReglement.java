 ...
 * @author Mlek
 */
public class FormTypeReglement extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        setClosable(true);
        setResizable(true);
        setTitle("Création Type Réglement");

        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder("Type Réglement"));

        jLabel1.setText("Type Réglement");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        bankDao.ajouterTypeReglement(c);
        update_table();
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        bankDao.supprimerTypeReglements(value);
        update_table();
        // TODO add your handling code here:
    ...
    private void update_table() {
        BankDao bankDao = new BankDao();
        bankDao.afficherTypeReglement(Bank_Table);
