...
public class FormBank extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        setClosable(true);
        setResizable(true);
        setTitle("Création Banque");

        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder("Banque"));

        jLabel1.setText("Nom Banque");
    ...
    private void update_table() {
        BankDao bankDao = new BankDao();
        bankDao.afficherBank(Bank_Table);
