 ...
 * @author Mlek
 */
public class MAJMargeForm extends javax.swing.JInternalFrame {
    ...
    public void SearchStockArticle() {
        try {
            ...
            stockDAO.afficherMarge(Table_Article, r.getId_depot(), r.getId_famille(), r.getId_sous_famille(), r.getDesignation(),
            ...
            try {
                ...
                Logger.getLogger(MAJMargeForm.class.getName()).log(Level.SEVERE, null, ex);
            }
        }
    }
    ...
    private void initComponents() {
        ...
        jButton1.setText("Modifier Famille");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        MAJMargeParFamilleUniFiltreForm c;
        c = new MAJMargeParFamilleUniFiltreForm();
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        if (!txt_stock_new.getText().isEmpty()) {
            if (row == -1) {
                ...
                if (JOptionPane.showConfirmDialog(null, "Voulez-vous changer la marge de tous les produits dans la table ci-dessous:  par " + stock_new, "Confirmation !!!",
