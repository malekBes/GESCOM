 ...
 * @author Mlek
 */
public class MAJRmiseParFamilleForm extends javax.swing.JInternalFrame {
    ...
    public void SearchStockArticle() {
        try {
            ...
            stockDAO.afficherRemiseParFamille(Table_Article, r.getId_famille(), id_client);
            ...
            try {
                ...
                Logger.getLogger(MAJRmiseParFamilleForm.class.getName()).log(Level.SEVERE, null, ex);
            }
        }
    }
    ...
    private void initComponents() {
        ...
        setClosable(true);
        setResizable(true);
        setTitle("MAJ Remise Par Famille");
...
//        SearchStockArticle();
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        // TODO add your handling code here:
        Article r = setArticleFromEditText();
        if ((!id_client.isEmpty()) && (!r.getId_famille().isEmpty()) && (!txt_stock_new.getText().isEmpty())) {
            stockDAO.insertRemiseParFamille(r);
            id_client = "";
            txt_search.setText("");
