 ...
 * @author Mlek
 */
public class MAJStockForm extends javax.swing.JInternalFrame {
    ...
    void setHeaders() {
        Table_Article.getColumnModel().getColumn(0).setHeaderValue("Ref Article");
        Table_Article.getColumnModel().getColumn(1).setHeaderValue("Designation");

        Table_Article.getColumnModel().getColumn(2).setHeaderValue("Quantité");
        Table_Article.getColumnModel().getColumn(3).setHeaderValue("Qte réservé");

        Table_Article.getTableHeader().resizeAndRepaint();
    ...
    public void SearchStockArticle() {
        try {
            ...
            stockDAO.afficherStockArticle(Table_Article, r.getId_depot(), r.getId_famille(), r.getId_sous_famille(), r.getDesignation(),
            ...
            try {
                ...
                Logger.getLogger(MAJStockForm.class.getName()).log(Level.SEVERE, null, ex);
            }
        }
    }
    ...
    private void initComponents() {
        ...
        jLabel10.setText("Stock Actuel");

        jLabel11.setText("Nouveau Stock");
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        if (!txt_stock_new.getText().isEmpty()) {
            if (row == -1) {
                ...
                if (JOptionPane.showConfirmDialog(null, "Voulez-vous changer le stock de tous les produits dans la table ci-dessous:  par " + stock_new, "Confirmation !!!",
                    ...
                    for (int j = 0; j < Table_Article.getRowCount(); j++) {
                        ...
                        stockDAO.updateArticleStock(ref, stock_new, design, oldStock);
                    }
                    JOptionPane.showMessageDialog(null, "le Stock a été mise a jour avec succses !");
                ...
                String stock_new = txt_stock_new.getText().toString();
                if (JOptionPane.showConfirmDialog(null, "Voulez vous modifer Stock Produit ref : " + ref + " par " + stock_new, "Confirmation !!!",
                        JOptionPane.YES_NO_OPTION) == JOptionPane.YES_OPTION) {
                    String design = Table_Article.getModel().getValueAt(row, 1).toString();
                    String oldStock = Table_Article.getModel().getValueAt(row, 2).toString();
            ...
            JOptionPane.showMessageDialog(this, "Champs Nouveau Stock est vide");
        }
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        if (row == -1) {
            data1 = stockDAO.afficherHistoriqueStock("-1");
        } else {
            String ref = Table_Article.getModel().getValueAt(row, 0).toString();
            data1 = stockDAO.afficherHistoriqueStock(ref);
        }
