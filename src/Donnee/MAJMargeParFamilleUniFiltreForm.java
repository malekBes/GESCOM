 ...
 * @author Mlek
 */
public class MAJMargeParFamilleUniFiltreForm extends javax.swing.JInternalFrame {
     ...
     */
    public MAJMargeParFamilleUniFiltreForm() {
         initComponents();
        setIconifiable(true);
        setMaximizable(true);
        setResizable(true);
...
//setHeaders();
            ...
            try {
                ...
                Logger.getLogger(MAJMargeParFamilleUniFiltreForm.class.getName()).log(Level.SEVERE, null, ex);
            }
        }
    }
    ...
    private void initComponents() {
        ...
        Filtre.setBorder(javax.swing.BorderFactory.createTitledBorder("Article"));
            ...
            .addGroup(layout.createSequentialGroup()
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGap(59, 59, 59)
                        .addComponent(Filtre, javax.swing.GroupLayout.PREFERRED_SIZE, 394, javax.swing.GroupLayout.PREFERRED_SIZE)
