 ...
 * @author Mlek
 */
public class AlertReglementForm extends javax.swing.JInternalFrame {
    ...
    private void update_table() {
        ...
        try {
            ...
            try {
                ...
                Logger.getLogger(AlertReglementForm.class.getName()).log(Level.SEVERE, null, ex);
            }
        }
    ...
    public void SearchDevis() {
        try {
            ...
            rechercheDao.afficherFactureAlert(FactureHist_Table, FromDate,
                    ToDate, "", "", txt_num_devis.getText(),
                    id_client, type_filtre, commercial_id);
            // setHeaders();
        } catch (Exception e) {
    ...
    void setHeaders() {
        ...
        FactureHist_Table.getColumnModel().getColumn(7).setHeaderValue("Dépassé O/N");
        FactureHist_Table.getColumnModel().getColumn(8).setHeaderValue("Echéance");
        FactureHist_Table.getColumnModel().getColumn(9).setHeaderValue("Ecart");
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        try {
            ...
            h.put("table_title", "Alert Reglement Impayée");

            JasperReport jr = JasperCompileManager.compileReport(
                    ClassLoader.getSystemResourceAsStream("alerts/AlertFactureImpayee.jrxml"));

            JasperPrint jp = JasperFillManager.fillReport(jr, h, new JRTableModelDataSource(model));

            JasperExportManager.exportReportToPdfFile(jp, Commen_Proc.PathPDF + "Alert Reglement Impayée.pdf");

            File myObj = new File(Commen_Proc.PathExcel + "Alert Reglement Impayée" + ".xls");
            Config.ExpotToExcel.exportExcelStat(FactureHist_Table, myObj, "Alert Reglement Impayée");
