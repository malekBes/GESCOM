 ...
 * @author Mlek
 */
public class RecherchFactureDechargeForm extends javax.swing.JInternalFrame {
     ...
     */
    public RecherchFactureDechargeForm() {
        ...
        buttonGroupDecharge.add(RadioButtonAllFacture);
        buttonGroupDecharge.add(RadioButtonWithDecharge);
        buttonGroupDecharge.add(RadioButtonNoDecharge);
        RadioButton_all.setSelected(true);//
        RadioButtonAllFacture.setSelected(true);//
    ...
    private void update_table() {
        ...
        try {
            ...
            try {
                ...
                Logger.getLogger(RecherchFactureDechargeForm.class.getName()).log(Level.SEVERE, null, ex);
            }
        }
    ...
    private void initComponents() {
        ...
        buttonGroupDecharge = new javax.swing.ButtonGroup();
        ...
        RadioButtonWithDecharge = new javax.swing.JRadioButton();
        RadioButtonNoDecharge = new javax.swing.JRadioButton();
        RadioButtonAllFacture = new javax.swing.JRadioButton();
        ...
        CheckBoxDecharge = new javax.swing.JCheckBox();
        jButton2 = new javax.swing.JButton();

        setClosable(true);
        setTitle("Décharge Facture");
        ...
        jLabel5.setText("Facture avec décharge : ");

        RadioButtonWithDecharge.setText("Oui");
        RadioButtonWithDecharge.addChangeListener(new javax.swing.event.ChangeListener() {
            public void stateChanged(javax.swing.event.ChangeEvent evt) {
                RadioButtonWithDechargeStateChanged(evt);
            }
        });
        RadioButtonWithDecharge.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                RadioButtonWithDechargeActionPerformed(evt);
            }
        });

        RadioButtonNoDecharge.setText("Non");
        RadioButtonNoDecharge.addChangeListener(new javax.swing.event.ChangeListener() {
            public void stateChanged(javax.swing.event.ChangeEvent evt) {
                RadioButtonNoDechargeStateChanged(evt);
            }
        });
        RadioButtonNoDecharge.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                RadioButtonNoDechargeActionPerformed(evt);
            }
        });

        RadioButtonAllFacture.setText("Tous");
        RadioButtonAllFacture.addChangeListener(new javax.swing.event.ChangeListener() {
            public void stateChanged(javax.swing.event.ChangeEvent evt) {
                RadioButtonAllFactureStateChanged(evt);
            }
        });
        RadioButtonAllFacture.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                RadioButtonAllFactureActionPerformed(evt);
            }
        });
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addComponent(RadioButtonWithDecharge)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                        .addComponent(RadioButtonNoDecharge)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                        .addComponent(RadioButtonAllFacture)
                        .addGap(0, 0, Short.MAX_VALUE)))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel1Layout.createSequentialGroup()
        ...
        CheckBoxDecharge.setText("Décharge");
    ...
    public void SearchDevis() {
        try {
            ...
            if (RadioButtonAllFacture.isSelected()) {
                type_filtre_decharge = "";
            } else if (RadioButtonWithDecharge.isSelected()) {
                type_filtre_decharge = "1";
            } else if (RadioButtonNoDecharge.isSelected()) {
                type_filtre_decharge = "0";
            }

            rechercheDao.afficherFactureDecharge(FactureHist_Table, FromDate,
                    ToDate, txt_montant_from.getText(), txt_montant_to.getText(), txt_num_devis.getText(),
                    txt_search.getText(), type_filtre, type_filtre_decharge);
            setHeaders();
        } catch (Exception e) {
    ...
    private void FactureHist_TableMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_FactureHist_TableMousePressed
        ...
        try {
            ...
            String dechargeValue = FactureHist_Table.getModel().getValueAt(row, 5).toString();

            if (dechargeValue.equals("Oui")) {
                CheckBoxDecharge.setSelected(true);
            } else {
                CheckBoxDecharge.setSelected(false);
            }
            //client_table.setModel(buildTableModel(rs));
        } catch (Exception e) {
            JOptionPane.showMessageDialog(null, "Error in ClientFrom/load_Update_table :  " + e);
...
// TODO add your handling code here:
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        if (row == -1) {
            ...
            Facture.FactureDAO d = new FactureDAO();
            String table_click = FactureHist_Table.getModel().getValueAt(row, 1).toString();
            String decharge = "";
            if (CheckBoxDecharge.isSelected()) {
                decharge = "1";
            } else {
                decharge = "0";
            }
            d.setFactureDecharge(table_click, decharge);
            txt_num_devis.setText("");
            SearchDevis();
    ...
    private void RadioButtonWithDechargeActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_RadioButtonWithDechargeActionPerformed
        // TODO add your handling code here:
        if (RadioButtonAllFacture.isSelected()) {
            type_filtre_decharge = "1";
            txt_num_devis.setText("");
    ...
    }//GEN-LAST:event_RadioButtonWithDechargeActionPerformed
    String type_filtre_decharge = "";
    private void RadioButtonAllFactureActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_RadioButtonAllFactureActionPerformed
        if (RadioButtonAllFacture.isSelected()) {
            type_filtre_decharge = "";
            txt_num_devis.setText("");
            SearchDevis();
        ...
        // TODO add your handling code here:
    }//GEN-LAST:event_RadioButtonAllFactureActionPerformed

    private void RadioButtonNoDechargeActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_RadioButtonNoDechargeActionPerformed
        // TODO add your handling code here:
        if (RadioButtonAllFacture.isSelected()) {
            type_filtre_decharge = "0";
            txt_num_devis.setText("");
    ...
    }//GEN-LAST:event_RadioButtonNoDechargeActionPerformed

    private void RadioButtonNoDechargeStateChanged(javax.swing.event.ChangeEvent evt) {//GEN-FIRST:event_RadioButtonNoDechargeStateChanged
        // TODO add your handling code here:

    }//GEN-LAST:event_RadioButtonNoDechargeStateChanged

    private void RadioButtonWithDechargeStateChanged(javax.swing.event.ChangeEvent evt) {//GEN-FIRST:event_RadioButtonWithDechargeStateChanged
        // TODO add your handling code here:

    }//GEN-LAST:event_RadioButtonWithDechargeStateChanged

    private void RadioButtonAllFactureStateChanged(javax.swing.event.ChangeEvent evt) {//GEN-FIRST:event_RadioButtonAllFactureStateChanged
        // TODO add your handling code here:

    }//GEN-LAST:event_RadioButtonAllFactureStateChanged
    ...
    private javax.swing.JCheckBox CheckBoxDecharge;
    ...
    private javax.swing.JRadioButton RadioButtonAllFacture;
    private javax.swing.JRadioButton RadioButtonNoDecharge;
    private javax.swing.JRadioButton RadioButtonWithDecharge;
    ...
    private javax.swing.ButtonGroup buttonGroupDecharge;
