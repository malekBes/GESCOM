 ...
 * @author Mlek
 */
public class ListArticleForm extends javax.swing.JInternalFrame {
    ...
    public void SearchStockArticle() {
        try {
            ...
            articleDao.afficherListeArticle(Table_Article, r.getId_depot(), r.getId_famille(), r.getId_sous_famille(), r.getDesignation(),
            ...
            try {
                ...
                Logger.getLogger(ListArticleForm.class.getName()).log(Level.SEVERE, null, ex);
            }
        }
    }
