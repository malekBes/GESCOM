 ...
 * @author Mlek
 */
public class RecherchReliquatDetailForm extends javax.swing.JInternalFrame {
     ...
     */
    public RecherchReliquatDetailForm() {
        initComponents();
        setIconifiable(true);
        setMaximizable(true);
        setResizable(true);
        Exporter.setVisible(false);
        ListExport.setVisible(false);
    ...
    public void SearchDevis() {
        try {
            ...
            rechercheDao.afficherReliquat(DevisHist_Table, FromDate,
    ...
    private void initComponents() {
        ...
        setClosable(true);
        setMaximizable(true);
        setTitle("Consultation Détail Reliquat");

        jPanel5.setBorder(javax.swing.BorderFactory.createTitledBorder("Reliquat"));
        ...
        jPanel3.setBorder(javax.swing.BorderFactory.createTitledBorder("Detail Reliquat"));
        ...
        jPanel4Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel4Layout.createSequentialGroup()
                ...
                .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addComponent(Exporter, javax.swing.GroupLayout.DEFAULT_SIZE, 113, Short.MAX_VALUE)
    ...
    private void setHeadersDetail() {
        ...
        DevisHistDetail_Table.getColumnModel().getColumn(1).setHeaderValue("Num Reliquat");
    ...
    public void showAllReliquetDetail() {
        try {
            BLDao devisDao = new BLDao();
            //   FormBL fr = new FormBL("", "", "");
            String table_click = "";
            for (int count = 0; count < DevisHist_Table.getModel().getRowCount(); count++) {
                table_click += "'" + DevisHist_Table.getModel().getValueAt(count, 1).toString() + "',";
            }
            table_click = table_click.substring(0, table_click.length() - 1);
            devisDao.afficherDetailRechercheMultipleReliquat(DevisHistDetail_Table, table_click);
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        try {
            ...
            DefaultTableModel model = (DefaultTableModel) DevisHistDetail_Table.getModel();
            h.put("table_title", "Détail Reliquat");

            JasperReport jr = JasperCompileManager.compileReport(
                    ClassLoader.getSystemResourceAsStream("statPrint/DetailReliquat.jrxml"));

            JasperPrint jp = JasperFillManager.fillReport(jr, h, new JRTableModelDataSource(model));

            JasperExportManager.exportReportToPdfFile(jp, Commen_Proc.PathPDF + "DetailReliquat.pdf");

            JasperViewer.viewReport(jp, false);

            File myObj = new File(Commen_Proc.PathExcel + "DetailReliquat" + ".xls");
            Config.ExpotToExcel.exportExcelStat(DevisHistDetail_Table, myObj, "DetailReliquat");
        } catch (Exception e) {
