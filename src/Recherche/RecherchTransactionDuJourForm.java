 ...
 * @author Mlek
 */
public class RecherchTransactionDuJourForm extends javax.swing.JInternalFrame {
     ...
     */
    public RecherchTransactionDuJourForm() {
        initComponents();
        setIconifiable(true);
        setMaximizable(true);
        setResizable(true);
        ...
        Date date = new Date();
        Date_Devis.setDate(date);
        Date_Devis_To.setDate(date);
    ...
    public void SearchDevis() {
        try {
            ...
            rechercheDao.afficherEtatDuJour(DevisHist_Table, FromDate,
    ...
    private void DevisHist_TableMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_DevisHist_TableMousePressed
        ...
        try {
            ...
            devisDao.afficherDetailRechercheDevis(DevisHistDetail_Table, table_click);
            ...
            if (row == -1) {
                ...
                if (JOptionPane.showConfirmDialog(null, "Avec en-tête ?", "Edition",
                    ...
                    new ReportGenarator().genarateReport(
                            ReportGenarator.REPORT_Devis_Entete, map, conn, file_name, DevisHistDetail_Table, num_devis);
                } else {
                    new ReportGenarator().genarateReport(
                            ReportGenarator.REPORT_Devis, map, conn, file_name, DevisHistDetail_Table, num_devis);
                }
