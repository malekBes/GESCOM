 ...
 * @author Mlek
 */
public class RecherchFactureAchatForm extends javax.swing.JInternalFrame {
     ...
     */
    public RecherchFactureAchatForm() {
    ...
    private void update_table() {
        ...
        try {
            ...
            try {
                ...
                Logger.getLogger(RecherchFactureAchatForm.class.getName()).log(Level.SEVERE, null, ex);
            }
        }
    ...
    private void initComponents() {
        ...
        setClosable(true);
        setTitle("Consultation Facture Achat");
    ...
    public void SearchDevis() {
        try {
            ...
            rechercheDao.afficherFactureAchat(FactureHist_Table, FromDate,
    ...
    private void FactureHist_TableMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_FactureHist_TableMousePressed
        ...
        try {
            ...
            devisDao.afficherDetailFactureAchat(FactureHistDetail_Table, table_click);
