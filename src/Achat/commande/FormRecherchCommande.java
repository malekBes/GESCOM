 ...
 * @author Mlek
 */
public class FormRecherchCommande extends javax.swing.JInternalFrame {
    ...
    public FormRecherchCommande() {
        ...
        jPanel_hidden.setVisible(false);
    ...
    private void initComponents() {
        ...
        setMaximizable(true);
        setResizable(true);
        setTitle("Consultation global des Commande");
        ...
        jPanel_hidden.setBorder(javax.swing.BorderFactory.createTitledBorder("Commande"));
        ...
        jPanel_hiddenLayout.setVerticalGroup(
            jPanel_hiddenLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGroup(jPanel_hiddenLayout.createSequentialGroup()
                .addContainerGap()
...
void setHeaders() {
    ...
    private void DevisHist_TableMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_DevisHist_TableMousePressed
        try {
            ...
            commandeDAO.afficherDetailPre_CommandeForExcel(DevisHist_Table1, table_click);
            ClientDao clientDao = new ClientDao();
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        try {
            ...
            if (row == -1) {
                ...
                map.put("nb_rows", String.valueOf(DevisHist_Table1.getModel().getRowCount()));

                String file_name = "Commande " + num_pre_cmd;

                new ReportGenarator().genarateReport(
                        ReportGenarator.STAT_Commande, map, conn, file_name, DevisHist_Table1, "cm;" + num_pre_cmd);
    ...
    private void setHeadersDetail() {
        ...
        DevisHistDetail_Table.getColumnModel().getColumn(1).setHeaderValue("Num Pré-Commande");
        DevisHistDetail_Table.getColumnModel().getColumn(2).setHeaderValue("Nom Client");
        DevisHistDetail_Table.getColumnModel().getColumn(3).setHeaderValue("Date Pré-Commande");
