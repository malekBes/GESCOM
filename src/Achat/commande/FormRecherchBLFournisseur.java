 ...
 * @author Mlek
 */
public class FormRecherchBLFournisseur extends javax.swing.JInternalFrame {
     ...
     */
    public FormRecherchBLFournisseur() {
         initComponents();
        setIconifiable(true);
        setMaximizable(true);
        setResizable(true);
    ...
    public void SearchDevis(String Filtre) {
        try {
            ...
            commandeDAO.afficherBLAchat(DevisHist_Table, FromDate,
    ...
    private void initComponents() {
        ...
        setMaximizable(true);
        setResizable(true);
        setTitle("Consultation BL Achat");
...
void setHeaders() {
    ...
    private void DevisHist_TableMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_DevisHist_TableMousePressed
        try {
            ...
            commandeDAO.afficherDetailBLAchat(DevisHistDetail_Table, table_click);
    ...
    private void setHeadersDetail() {
        ...
        DevisHistDetail_Table.getColumnModel().getColumn(3).setHeaderValue("Désignation");
        DevisHistDetail_Table.getColumnModel().getColumn(4).setHeaderValue("Quantité");
        DevisHistDetail_Table.getColumnModel().getColumn(5).setHeaderValue("Prix Unitaire");
        ...
        DevisHistDetail_Table.getColumnModel().getColumn(8).setHeaderValue("Total HT");
        DevisHistDetail_Table.getColumnModel().getColumn(9).setHeaderValue("Total TTC");
