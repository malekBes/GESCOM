 ...
 * @author Mlek
 */
public class AnnulationCommandeAchatForm extends javax.swing.JInternalFrame {

    /**
     * Creates new form ReglementForm
     */
    public AnnulationCommandeAchatForm() {
        initComponents();
        setIconifiable(true);
        setMaximizable(true);
        setResizable(true);
    ...
    private void initComponents() {
        ...
        setTitle("Annulation Commande Fournisseur");
    ...
    private void txt_num_devisKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txt_num_devisKeyPressed
        ...
        if (evt.getKeyCode() == evt.VK_ENTER) {
            ...
            df = blDao.afficherDetailCommandeAchat(Table_detail, table_click);
            String s = blDao.afficherCommandeAchatPourAnnuler(Table_detail, table_click);
            String[] x = s.split(";");
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        try {
            ...
            if (!txt_num_devis.getText().isEmpty()) {
                if (JOptionPane.showConfirmDialog(null, "Voulez-vous Annuler la Commande Num : " + txt_num_devis.getText(), "Confirmation !!!",
                        JOptionPane.YES_NO_OPTION) == JOptionPane.YES_OPTION) {

                    DevisDao devisDao = new DevisDao();
                    String s = "";
                    for (int i = 0; i < Table_detail.getRowCount(); i++) {
                        s += Table_detail.getValueAt(i, 2).toString() + ",";
                    }
                    devisDao.supprimerCommandeAchat(txt_num_devis.getText(), s);
                    JOptionPane.showMessageDialog(this, "Commande Num " + txt_num_devis.getText() + " à été Annulée ! ");
// ajouter qte to stock 
                ...
                JOptionPane.showMessageDialog(this, "Num Commande est vide !");
            }
        } catch (Exception e) {
            JOptionPane.showMessageDialog(this, "Error In annulation Commande : " + e.getMessage());
