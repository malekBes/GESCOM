 ...
 * @author Mlek
 */
public class ModifPreCommandeAchatForm extends javax.swing.JInternalFrame {

    /**
     * Creates new form ReglementForm
     */
    public ModifPreCommandeAchatForm() {
         initComponents();
        setIconifiable(true);
        setMaximizable(true);
        setResizable(true);
    ...
    private void initComponents() {
        ...
        setTitle("Modification Pré-Commande Fournisseur");
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        try {
            ...
            if (!txt_num_devis.getText().isEmpty()) {
                ...
                c = new pre_commandeForm(txt_num_devis.getText(), "Modif");
