 ...
 * @author Mlek
 */
public class HistoriqueDevis_FacturePassager extends javax.swing.JInternalFrame {
     ...
     */
    public HistoriqueDevis_FacturePassager() {
    ...
    private void update_table() {
        ...
        try {
            ...
            try {
                ...
                Logger.getLogger(HistoriqueDevis_FacturePassager.class.getName()).log(Level.SEVERE, null, ex);
            }
        }
    ...
    private void initComponents() {
        ...
        setClosable(true);
        setTitle("Historique Devis (Passager)");
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGap(41, 41, 41)
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(Date_Devis, javax.swing.GroupLayout.DEFAULT_SIZE, 217, Short.MAX_VALUE)
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        ...
        if (value.isEmpty()) {
            c = new FormFacturePassager("", "", "");
        } else {
            String client = "";
            try {
                client = DevisHist_Table.getModel().getValueAt(row, 0).toString();
            } catch (NullPointerException e) {
                client = "";
            }
            c = new FormFacturePassager(value, client.isEmpty() ? "" : client, "");
        }
    ...
    private void DevisHist_TableMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_DevisHist_TableMousePressed
        ...
        try {
            ...
            devisDao.afficherDetailDevis(DevisHistDetail_Table, table_click, false);
