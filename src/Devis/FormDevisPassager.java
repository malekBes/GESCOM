 ...
 * @author Mlek
 */
public class FormDevisPassager extends javax.swing.JInternalFrame {
    ...
    public FormDevisPassager(String Num_Devis, String client) {
        ...
        if (!Num_Devis.isEmpty()) {
            ...
            String[] array = null;
            if (client.isEmpty()) {
                nom_and_codeTva = dart.getNameItemByIdJoinTablesPassager("devis", "num_devis", Num_Devis);

                array = nom_and_codeTva.split(";");
    ...
    public void setImportedDevis(String Num_Devis) {
        ...
        df = devisDao.afficherDetailMultipleDevis(Devis_Table, Num_Devis, true);
        Devis_Table.setModel(df);
        reCalculerTT();
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        try {
            ...
            if (c.DateCheckOnUpdate("devis", "date_devis", "num_devis", d.getNum_Devis(), d.getDate_devis())) {
                ...
                if (s.isEmpty()) {
                    if (devisDao.ajouterDevisPassager(d)) {
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        // TODO add your handling code here:
        HistoriqueDevisPassager c = new HistoriqueDevisPassager();
        Home.App.d.add(c);
