 ...
 * @author Mlek
 */
public class HistoriqueDevisPassager extends javax.swing.JInternalFrame {
     ...
     */
    public HistoriqueDevisPassager() {
    ...
    private void update_table() {
        ...
        try {
            ...
            try {
                ...
                Logger.getLogger(HistoriqueDevisPassager.class.getName()).log(Level.SEVERE, null, ex);
            }
        }
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        ...
        if (s.isEmpty()) {
            ...
            c = new FormDevisPassager(s, client.isEmpty() ? "" : client);
        }
