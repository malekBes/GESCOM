...
public class ligneDevis {
    ...
    public ligneDevis(int id, String id_client, String id_Devis, String ref_article, String design, Double prix_U, String qte, Double total_HT, String remise, String TVA, Double totale_TTC) {
        this.id = id;
