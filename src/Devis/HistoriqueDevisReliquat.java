 ...
 * @author Mlek
 */
public class HistoriqueDevisReliquat extends javax.swing.JInternalFrame {
     ...
     */
    public HistoriqueDevisReliquat() {
    ...
    private void update_table() {
        ...
        try {
            DevisDao devisDao = new DevisDao();
            Devis_df = devisDao.afficherDevis(DevisHist_Table);
            ...
            try {
                ...
                Logger.getLogger(HistoriqueDevisReliquat.class.getName()).log(Level.SEVERE, null, ex);
            }
        }
    ...
    private void initComponents() {
        ...
        setClosable(true);
        setTitle("Historique Devis (Reliquat)");
        setToolTipText("");
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
       ...
       // ArrayList<String> lst = new ArrayList<>();
        ...
        if (s.isEmpty()) {
            c = new FormReliquat(s, "");
        } else {
            c = new FormReliquat(s, "Import");
        }
