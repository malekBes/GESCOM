 ...
 * @author Mlek
 */
public class FormReliquat extends javax.swing.JInternalFrame {
    ...
    public FormReliquat(String LstNum_Devis, String type) {
...
//Double.valueOf((formatDouble(Total_TTC)))
    ...
    private void initComponents() {
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder("Infos Reliquat"));
        ...
        jPanel4.setBorder(javax.swing.BorderFactory.createTitledBorder("Validation Reliquat"));
...
// TODO add your handling code here:
    ...
    private void setNumDevis() {
        ...
        String s = devisDao.maxNumReliquat(year + "R");
        String formatted;
        if (!s.isEmpty()) {
            String t[] = s.split("R");
