...
public class BL {
    ...
    int timbre;
    String id_depot_src;
    String id_depot_dest;

    public BL(int id, String Num_bl, String Date_bl, int id_client, int id_commercial, Double remise, Double Totale_HT, Double Totale_TTC, String Code_TVA, String infos_bl, int exh_TVA, int Afficher_total, int facture_proformat, int Afficher_validiter, int Afficher_prix, int Edit_ref) {
        this.id = id;
        this.Num_bl = Num_bl;
    ...
    public String getId_depot_src() {
        return id_depot_src;
    }

    public void setId_depot_src(String id_depot_src) {
        this.id_depot_src = id_depot_src;
    }

    public String getId_depot_dest() {
        return id_depot_dest;
    }

    public void setId_depot_dest(String id_depot_dest) {
        this.id_depot_dest = id_depot_dest;
    }
