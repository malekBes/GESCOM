 ...
 * @author Mlek
 */
public class AnnulationBLForm extends javax.swing.JInternalFrame {

    /**
     * Creates new form ReglementForm
     */
    public AnnulationBLForm() {
         initComponents();
        setIconifiable(true);
        setMaximizable(true);
        setResizable(true);
...
/*
    ...
    private void txt_num_devisKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txt_num_devisKeyPressed
        ...
        if (evt.getKeyCode() == evt.VK_ENTER) {
            ...
            df = blDao.afficherDetailBL(Table_detail, table_click);
            String s = blDao.afficherBLPourAnnuler(Table_detail, table_click);
            String[] x = s.split(";");
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        try {
            ...
            if (!txt_num_devis.getText().isEmpty()) {
                if (JOptionPane.showConfirmDialog(null, "Voulez-vous Annuler la BL Num : " + txt_num_devis.getText(), "Confirmation !!!",
                        JOptionPane.YES_NO_OPTION) == JOptionPane.YES_OPTION) {

                    DevisDao devisDao = new DevisDao();
                    devisDao.supprimerBL(txt_num_devis.getText());
                    JOptionPane.showMessageDialog(this, "BL Num " + txt_num_devis.getText() + " à été Annulée ! ");
// ajouter qte to stock 
                    ...
                    devisDao.modifierStockBLOnDelete(lst);
