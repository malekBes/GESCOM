 ...
 * @author Mlek
 */
public class ModifBLForm extends javax.swing.JInternalFrame {
...
/*
    ...
    private void txt_num_devisKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txt_num_devisKeyPressed
        ...
        if (evt.getKeyCode() == evt.VK_ENTER) {
            ...
            String s = blDao.afficherBLPourModif(null, table_click);
            if (!s.isEmpty()) {
                String[] x = s.split(";");
                txt_client.setText(x[2]);
                txt_total.setText(x[1]);
                txt_date.setText(x[0]);
                Invoiced = x[4]; //JOptionPane.showMessageDialog(this, s);}
            }
        }
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        try {
            ...
            JOptionPane.showMessageDialog(this, "Error In Modif BL client : " + e.getMessage());
    ...
    private void jButton7ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton7ActionPerformed
        ...
        Vector<Vector<Object>> data1 = DaoBL.afficherListBL("");
        ...
        jbtValider.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                ...
                //  df = blDao.afficherDetailBL(Table_detail, table_click);
                String s = blDao.afficherBLPourModif(null, nomclient);
                if (!s.isEmpty()) {
                    String[] x = s.split(";");
                    txt_client.setText(x[2]);
                    txt_total.setText(x[1]);
