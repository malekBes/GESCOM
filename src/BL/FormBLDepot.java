 ...
 * @author Mlek
 */
public class FormBLDepot extends javax.swing.JInternalFrame {
     ...
     */
    public FormBLDepot(String NumDevis, String id_client_exporter) {
    ...
    HashMap<String, String> depotDestHashMap;
    ...
    public void depotdestComboBox() {
        ArticleDao article = new ArticleDao();
        depotDestHashMap = article.listDepot(ComboBox_Depot_dest);
    }
    ...
    private void initComponents() {
        ...
        ComboBox_Depot_dest = new javax.swing.JComboBox<>();
        ...
        setClosable(true);
        setTitle("Bon de Livraisons Dépot");
        ...
        jLabel6.setText("Dépot Source");

        ComboBox_Depot_dest.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Item 1", "Item 2", "Item 3", "Item 4" }));
        ComboBox_Depot_dest.addItemListener(new java.awt.event.ItemListener() {
            public void itemStateChanged(java.awt.event.ItemEvent evt) {
                ComboBox_Depot_destItemStateChanged(evt);
            }
        });
        ComboBox_Depot_dest.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                ComboBox_Depot_destActionPerformed(evt);
            }
        });

        jLabel15.setText("Dépot Déstination");
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                            ...
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                ...
                                .addGap(18, 18, 18)
                                .addComponent(ComboBox_Depot_dest, javax.swing.GroupLayout.PREFERRED_SIZE, 160, javax.swing.GroupLayout.PREFERRED_SIZE)))
                        .addGap(104, 104, 104)
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    ...
                    .addComponent(ComboBox_Depot_dest, javax.swing.GroupLayout.PREFERRED_SIZE, 24, javax.swing.GroupLayout.PREFERRED_SIZE))
    ...
    private BL setDevisFromEditText() {
        ...
        if (!depot.equals("-")) {
            ...
            r.setId_depot_src(ss);
        } else {
            r.setId_depot_src("");
            return null;
        }
        
        String depot_dest = ComboBox_Depot_dest.getSelectedItem().toString();
        if (!depot_dest.equals("-")) {
            String ss = daoArticle.getNameItemById("depot", "id", "nom", depot_dest);
            r.setId_depot_dest(ss);
        } else {
            r.setId_depot_dest("");
            return null;
        }
 ...
 /* } catch (Exception e) {
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        try {
            ...
            if (BLDao.ajouterBLDepot(d)) {
                
                ArrayList<LigneBL> lstd;
                lstd = setLigneDevisFromDevisTable();
                BLDao.ajouterLigneBLDepot(lstd);
                JOptionPane.showMessageDialog(null, "num Bl Dépot " + txt_num_BL.getText() + " à été bien enregistré !");
                
                clearDevisLFields();
                setNumBL();
            } else {
                JOptionPane.showMessageDialog(null, "Error in CreateBL Dépot ActionPerformed ");
            }
        } catch (Exception e) {
            JOptionPane.showMessageDialog(null, "Error in Dépot/Ajouter_btn Dépot :  " + e);
        } finally {
            try {
...
//jTable.setRowSorter(rowSorter);
    ...
    private void ComboBox_Depot_destItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_ComboBox_Depot_destItemStateChanged
        // TODO add your handling code here:
    }//GEN-LAST:event_ComboBox_Depot_destItemStateChanged

    private void ComboBox_Depot_destActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ComboBox_Depot_destActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_ComboBox_Depot_destActionPerformed
    ...
    private javax.swing.JComboBox<String> ComboBox_Depot_dest;
    ...
    private void setNumBL() {
        ...
        String s = BLDao.maxNumBLDepot();
        String formatted;
        if (!s.isEmpty()) {
            String t[] = s.split("BLD");
            int x = Integer.valueOf(t[1]) + 1;
            formatted = String.format("%05d", x);
            String num_devis = year + "BLD" + formatted;
