 ...
 * @author Mlek
 */
public class AnnulationBLAchatForm extends javax.swing.JInternalFrame {

    /**
     * Creates new form ReglementForm
     */
    public AnnulationBLAchatForm() {
         initComponents();
        setIconifiable(true);
        setMaximizable(true);
        setResizable(true);
    ...
    private void initComponents() {
        ...
        setTitle("Annulation BL Fournisseur");
        ...
        try {
            ...
            if (!txt_num_devis.getText().isEmpty()) {
                if (JOptionPane.showConfirmDialog(null, "Voulez-vous Annuler la BL Num : " + txt_num_devis.getText(), "Confirmation !!!",
                    ...
                    devisDao.supprimerBLAchat(txt_num_devis.getText());
