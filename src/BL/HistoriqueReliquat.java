 ...
 * @author Mlek
 */
public class HistoriqueReliquat extends javax.swing.JInternalFrame {
    ...
    public HistoriqueReliquat(String param_type_operation, String paramNumBlExportModif) {
    ...
    private void update_table() {
        ...
        try {
            BLDao devisDao = new BLDao();
            devisDao.afficherReliquat(DevisHist_Table);
            ...
            try {
                ...
                Logger.getLogger(HistoriqueReliquat.class.getName()).log(Level.SEVERE, null, ex);
            }
        }
    ...
    public void SearchDevis() {
        try {
            ...
            devisDao.afficherReliquat(DevisHist_Table, FromDate,
    ...
    private void DevisHist_TableMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_DevisHist_TableMousePressed
        ...
        try {
            ...
            int row = DevisHist_Table.getSelectedRow();
            String table_click = DevisHist_Table.getModel().getValueAt(row, 1).toString();
            devisDao.afficherDetailReliquat(DevisHistDetail_Table, table_click);
