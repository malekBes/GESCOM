 ...
 * @author Mlek
 */
public class PreferedArticleForm extends javax.swing.JInternalFrame {
    ...
    public void SearchBL() {
        try {
            ...
            lstBL = a.afficherClientActivite(BLHist_Table, ComboBoxTypeArticle.getSelectedItem().toString(),
                    "");//txt_search_client.getText() a la place des deux ""
...
//jTable.setRowSorter(rowSorter);
    ...
    private void jButton9ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton9ActionPerformed
        ...
        try {
            if (!id_client.isEmpty() && !ComboBoxTypeArticle.getSelectedItem().toString().equals("-")) {
                ...
                JOptionPane.showMessageDialog(this, "Client Affecté");
    ...
    private void jButton10ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton10ActionPerformed
        ...
        try {
            ...
            String value = BLHist_Table.getModel().getValueAt(row, 0).toString();

            if (!value.isEmpty()) {
                ArticleDao a = new ArticleDao();
                a.updateClientClassificationParNom(value, ComboBoxTypeArticle.getSelectedItem().toString());
                JOptionPane.showMessageDialog(this, "Client désaffecté");
                SearchBL();
            } else {
                JOptionPane.showMessageDialog(this, "Verifier les champs !");
            }
