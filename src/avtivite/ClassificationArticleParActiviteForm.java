 ...
 * @author Mlek
 */
public class ClassificationArticleParActiviteForm extends javax.swing.JInternalFrame {
     ...
     */
    public ClassificationArticleParActiviteForm() {
...
TableModel tableModel;
    ...
    private void jButton7ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton7ActionPerformed
        ...
        Vector<Vector<Object>> data1 = clientDao.afficherListType_Article();
        ...
        frameListeClient = new JFrame("Liste Types");
        ...
        jbtValider.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                ...
                String t = jTable.getModel().getValueAt(jTable.getSelectedRow(), 1).toString();
                Type_article = t;
                getArticleByTypeArticle(t);
    ...
    private void jButton9ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton9ActionPerformed
        ...
        try {
            if (!Type_article.isEmpty()) {
                ArticleDao a = new ArticleDao();
                a.updateArticleClassification(Type_article, lstBLexport);

                JOptionPane.showMessageDialog(this, "Article Affecté");

            } else {
                JOptionPane.showMessageDialog(this, "Client est obligatoire");
            }
