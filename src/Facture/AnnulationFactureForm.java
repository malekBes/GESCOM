 ...
 * @author Mlek
 */
public class AnnulationFactureForm extends javax.swing.JInternalFrame {

    /**
     * Creates new form ReglementForm
     */
    public AnnulationFactureForm() {
         initComponents();
        setIconifiable(true);
        setMaximizable(true);
        setResizable(true);
            ...
            if (evt.getKeyCode() == evt.VK_ENTER) {
                ...
                if (!s.isEmpty()) {
                    ...
                    if (x[3].equals("Passager")) {
                        ...
                        Label_client_passager.setText("Client");
                        blDao.afficherDetailFacture(Table_detail, table_click);
                    }
        ...
        try {
            ...
            if (!txt_num_devis.getText().isEmpty()) {
                if (JOptionPane.showConfirmDialog(null, "Voulez-vous Annuler la Facture Num : " + txt_num_devis.getText(), "Confirmation !!!",
                    ...
                    devisDao.supprimerFacture(txt_num_devis.getText());
                    ...
                    ArrayList<ligne_facture> lstFacture = new ArrayList<ligne_facture>();
                    ...
                    for (int i = 0; i < Table_detail.getRowCount(); i++) {
                        ...
                        f.setNum_bl(Table_detail.getValueAt(i, 1).toString());
                        f.setNum_facture(txt_num_devis.getText());
                        lstFacture.add(f);
                        
                    }
                    devisDao.DeleteLigneFacture(lstFacture);
