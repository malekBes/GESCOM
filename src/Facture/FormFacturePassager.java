 ...
 * @author Mlek
 */
public class FormFacturePassager extends javax.swing.JInternalFrame {
    ...
    public FormFacturePassager(String Num_Devis, String client, String type) {
        ...
        if (!Num_Devis.isEmpty()) {
            if (type.equals("Modif")) {
                ...
                type_operation = type;
                setImportedFacture(Num_Devis);
                setImportedTableHeader();
                formatTableValues();
                txt_passager.setText(client);
                txt_num_devis.setText(Num_Devis);
                String codetva_adresse_timbre_info = dart.getNameItemByIdJoinTablesFacturePassager("facture", "num_facture", Num_Devis, "Client");
                String[] x = codetva_adresse_timbre_info.split(";");
                txt_Code_TVA.setText(x[0]);
                ...
                txt_infos_devis.setText(x[3]);
                txt_num_devis.setEnabled(false);

                // Date_Devis.setEnabled(true);
                String date = dart.getDateByNumFacture(Num_Devis);
                try {
                ...
                String nom_and_codeTva_timbre = "";
                String[] array = null;
                if (client.isEmpty()) {
                    nom_and_codeTva_timbre = dart.getNameItemByIdJoinTablesPassager("devis", "num_devis", Num_Devis);

                    array = nom_and_codeTva_timbre.split(";");
                    txt_passager.setText(array[1]);
                    txt_adresse.setText(array[3]);
                } else {
                    nom_and_codeTva_timbre = dart.getNameItemByIdJoinTables("devis", "num_devis", Num_Devis);
                    array = nom_and_codeTva_timbre.split(";");
                }
    ...
    public void setImportedFacture(String Num_Devis) {
        DevisDao devisDao = new DevisDao();
        df = new DefaultTableModel();
        df = devisDao.afficherDetailFacturePassager(Devis_Table, Num_Devis, true);
        Devis_Table.setModel(df);
        reCalculerTT();
    ...
    private void initComponents() {
        ...
        setClosable(true);
        setTitle("Facture Passager");

        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder("Infos Facture"));
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                                .addComponent(txt_passager, javax.swing.GroupLayout.PREFERRED_SIZE, 154, javax.swing.GroupLayout.PREFERRED_SIZE)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGap(42, 42, 42)
                        .addComponent(txt_adresse, javax.swing.GroupLayout.PREFERRED_SIZE, 153, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)))
        ...
        jPanel4.setBorder(javax.swing.BorderFactory.createTitledBorder("Validation Facture"));
    ...
    ArrayList<ligneDevis> lstdmodif;
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        try {
            ...
            if (c.DateCheckOnUpdate("facture", "date_facture", "num_facture", d.getNum_Devis(), d.getDate_devis())) {
                if (type_operation.equals("Modif")) {
                    if (factureDAO.modifierFacturePassager(d)) {
                        //  devisDao.modifierStock(lstd);
                        devisDao.modifierStockAddFacturePassager(lstdmodif);
                        devisDao.modifierStockFacturePassagerOnUpdate(lstd);
                        factureDAO.modifierLigneFacturePassager(lstd);
                        JOptionPane.showMessageDialog(null, "Facture num " + txt_num_devis.getText() + " à été bien Modifiée !");

                        clearDevisLFields();
                        setNumFacture();
                    } else {
                        JOptionPane.showMessageDialog(null, "Error in CreateFacture ActionPerformed ");
                    }
                } else {
                    String s = VerifStock(lstd);
                    if (s.isEmpty()) {
                        if (factureDAO.ajouterFacturePassager(d)) {
                            factureDAO.ajouterLigneFacturePassager(lstd);
                            JOptionPane.showMessageDialog(null, "Facture num " + txt_num_devis.getText() + " à été bien enregistré !");
                            devisDao.modifierStock(lstd);
            ...
            JOptionPane.showMessageDialog(null, "Error in FactureFrom/Ajouter_btn :  " + e);
        } finally {
            try {
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        // TODO add your handling code here:
        HistoriqueDevis_FacturePassager c = new HistoriqueDevis_FacturePassager();
        Home.App.d.add(c);
