 ...
 * @author Mlek
 */
public class ListeGroupeArticleForm extends javax.swing.JInternalFrame {
    ...
    public void SearchStockArticle() {
        try {
         //   Article r = setArticleFromEditText();
            ...
            articleDao.afficherListeArticleProspection(Table_Article, depot, "", "", "",
                    "", "");
            ...
            try {
                ...
                Logger.getLogger(ListeGroupeArticleForm.class.getName()).log(Level.SEVERE, null, ex);
            }
        }
    }
    ...
    public void depotComboBox() {
        ArticleDao article = new ArticleDao();
        marqueHashMap = article.listProspection(ComboBox_Depot);
    }
    ...
    private void initComponents() {
        ...
        setClosable(true);
        setResizable(true);
        setTitle("Consultation Groupe Prospection");

        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder("Article"));

        jLabel6.setText("Groupe Prospection");
    ...
    private Article setArticleFromEditText() {
        ...
        try {
            ...
            String depot = ComboBox_Depot.getSelectedItem().toString();
            if (!depot.equals("-")) {
                //String ss = daoArticle.getNameItemById("article", "ref", "groupe_prospection", depot);
                r.setId_depot(depot);
            } else {
